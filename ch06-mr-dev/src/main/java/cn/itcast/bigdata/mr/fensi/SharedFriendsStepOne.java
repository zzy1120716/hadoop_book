...
public class SharedFriendsStepOne {
    ...
    public static void main(String[] args) throws Exception {
        ...
        FileInputFormat.setInputPaths(job, new Path("/Users/zzy/Docs/hadoop_book/docs/大数据视频笔记/day10/friends"));
        FileOutputFormat.setOutputPath(job, new Path("/Users/zzy/Docs/hadoop_book/docs/大数据视频笔记/day10/friendsout-1"));
