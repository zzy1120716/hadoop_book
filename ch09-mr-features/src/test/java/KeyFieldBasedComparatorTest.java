...
public class KeyFieldBasedComparatorTest {
    ...
    private Text line1 = new Text("2\t30");
    private Text line2 = new Text("10\t4");
    private Text line3 = new Text("10\t30");
    ...
    private static DataOutputBuffer serialize(Writable writable) throws IOException {
