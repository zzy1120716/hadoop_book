import com.zzy.hadoopbook.common.NcdcRecordParser;
...
public class AvroSpecificMaxTemperature extends Configured implements Tool {
    ...
    public static class MaxTemperatureMapper extends AvroMapper<Utf8, Pair<Integer, WeatherRecord>> {
        ...
        @Override
        public void map(Utf8 line, AvroCollector<Pair<Integer, WeatherRecord>> collector, Reporter reporter) throws IOException {
            ...
            if(parser.isValidTemperature()) {
                ...
                collector.collect(new Pair<Integer, WeatherRecord>(parser.getYearInt(), record));
            }
        }
    }

    public static class MaxTemperatureReducer extends AvroReducer<Integer, WeatherRecord, WeatherRecord> {

        @Override
        public void reduce(Integer key, Iterable<WeatherRecord> values, AvroCollector<WeatherRecord> collector, Reporter reporter) throws IOException {
    ...
    public static class MaxTemperatureCombiner extends AvroReducer<Integer, WeatherRecord, Pair<Integer, WeatherRecord>> {

        @Override
        public void reduce(Integer key, Iterable<WeatherRecord> values, AvroCollector<Pair<Integer, WeatherRecord>> collector, Reporter reporter) throws IOException {
