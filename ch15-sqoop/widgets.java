...
//
// Debug information:
// Generated date: Tue Apr 03 11:05:10 CST 2018
  ...
  private void init0() {
    setters.put("id", new FieldSetterCommand() {
      ...
      public void setField(Object value) {
        widgets.this.id = (Integer)value;
      }
    });
    setters.put("widget_name", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        widgets.this.widget_name = (String)value;
      }
    });
    setters.put("price", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        widgets.this.price = (java.math.BigDecimal)value;
      }
    });
    setters.put("design_date", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        widgets.this.design_date = (java.sql.Date)value;
      }
    });
    setters.put("version", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        widgets.this.version = (Integer)value;
      }
    });
    setters.put("design_comment", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        widgets.this.design_comment = (String)value;
      }
    });
  }
  public widgets() {
