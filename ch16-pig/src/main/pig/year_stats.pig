...
--records = LOAD 'input/ncdc/all/19{1,2,3,4,5}0*'--部分数据
records = LOAD 'input/ncdc/all/190{1,2}*'--小型数据
    USING com.zzy.hadoopbook.pig.CutLoadFunc('5-10,11-15,16-19,88-92,93-93')
