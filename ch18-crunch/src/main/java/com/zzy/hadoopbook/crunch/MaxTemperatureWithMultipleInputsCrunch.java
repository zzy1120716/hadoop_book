...
import com.zzy.hadoopbook.crunch.parser.MetOfficeRecordParser;
...
public class MaxTemperatureWithMultipleInputsCrunch {
    ...
    public static void main(String[] args) throws Exception {
        if(args.length != 3) {
            System.err.println("Usage: MaxTemperatureWithMultipleInputsCrunch <ncdc input> <metoffice input> <output path>");
            System.exit(-1);
        }
