...
public class CheckpointTest {
    ...
    public void testCheckpoint() throws Exception {
        ...
        PipelineResult result1 = runCheckpointedPipeline(new MRPipeline(getClass()), inputPath);
        assertEquals(2, result1.getStageResults().size());

        PipelineResult result2 = runCheckpointedPipeline(new MRPipeline(getClass()), inputPath);
        assertEquals(1, result2.getStageResults().size());

    }

    private PipelineResult runCheckpointedPipeline(Pipeline pipeline, String inputPath) throws Exception {
