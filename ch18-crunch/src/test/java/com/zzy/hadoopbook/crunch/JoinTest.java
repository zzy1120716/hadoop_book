...
import static com.zzy.hadoopbook.crunch.tools.PCollections.invert;
...
public class JoinTest {
    ...
    @Before
    public void setup() {
        a = MemPipeline.typedTableOf(tableOf(ints(), strings()), 2, "Tie", 4, "Coat", 3, "Hat", 1, "Scarf");
        PTable<String, Integer> b0 = MemPipeline.typedTableOf(tableOf(strings(), ints()), "Joe", 2, "Hank", 4, "Ali", 0, "Eve", 3, "Hank", 2);
        b = invert(b0);
    }
